...
class Ball(
    ...
    /**
     * Initializes the ball's acceleration with the current phone orientation.
     * This is called after reset to ensure the ball starts moving in the correct direction.
     */
    fun initializeAcceleration(xAcc: Float, yAcc: Float) {
        accX = xAcc
        accY = yAcc
        isFirstUpdate = false
    }
